      ...
      <div className="contact-info">
        <div className="info-box">
          <div className="icon">
            ...
            <Image   layout="fill" objectFit="contain" src={`${process.env.NEXT_PUBLIC_FAVICON}/address-location-icon.png`} alt="address" />
            </div>
          </div>
        ...
        <div className="info-box">
          <div className="icon">
            ...
            <Image   layout="fill" objectFit="contain" src={`${process.env.NEXT_PUBLIC_FAVICON}/phone-call-icon.png`} alt="phone" />
            </div>
          </div>
          <div className="phone">
        ...
        <div className="info-box">
          <div className="icon">
            ...
            <Image   layout="fill" objectFit="contain" src={`${process.env.NEXT_PUBLIC_FAVICON}/email-icon.png`} alt="email" />
            </div>
          </div>
          <div className="email">
