    ...
    <div className="dr-list">
      <div className="box" id="dr-box1">
        <div className="heading">
          <div className="image">
          <Image   layout="fill" objectFit="contain" src={`${process.env.NEXT_PUBLIC_IMAGESPATH}/yvette.png`} alt="doctor" />
          </div>
      ...
      <div className="box" id="dr-box2">
        <div className="heading">
          ...
          <Image   layout="fill" objectFit="contain" src={`${process.env.NEXT_PUBLIC_IMAGESPATH}/susana.jpeg`} alt="doctor" />
          </div>
      ...
      <div className="box" id="dr-box3">
        <div className="heading">
          ...
          <Image   layout="fill" objectFit="contain" src={`${process.env.NEXT_PUBLIC_IMAGESPATH}/derrick.png`} alt="doctor" />
          </div>
