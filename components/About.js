...
const About = () => {
  return (
    ...
    <Image   layout="fill" objectFit="cover" src={`${process.env.NEXT_PUBLIC_IMAGESPATH}/dentalCare.jpg`} alt="dentist" />
    </div>
    <div className="second-half">
      ...
      <div className="s-list">
        <div className="s-h-l">
          <div className="check">
            <div className="image">
            <Image   layout="fill" objectFit="contain" src={`${process.env.NEXT_PUBLIC_IMAGESPATH}/check.png`} alt="check" />
            </div>
          </div>
